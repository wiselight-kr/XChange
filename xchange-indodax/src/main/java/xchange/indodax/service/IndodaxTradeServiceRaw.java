    ...
    protected IndodaxTradeServiceRaw(Exchange exchange) {
        ...
        this.indodaxAuthenticated=
                ExchangeRestProxyBuilder.forInterface(
                        ...
                        .build();
        this.apiSecret = IndodaxDigest.createInstance(exchange.getExchangeSpecification().getSecretKey());
    }

    public IndodaxTradeResponse placeLimitOrderRaw(CurrencyPair pair,
                                                   OrderSide type,
                                                   BigDecimal price,
                                                   BigDecimal idr,
                                                   BigDecimal btc){

        IndodaxTradeResponse response = indodaxAuthenticated.limitOrder
                (apiKey,apiSecret.toString(),"trade", IndodaxAdapter.toSymbol(pair),"buy",
